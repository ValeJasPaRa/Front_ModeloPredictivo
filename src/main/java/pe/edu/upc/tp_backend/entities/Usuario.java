...
public class Usuario implements Serializable {
    ...
    @Column(name = "fechaRegistro_usuario", updatable = false)
    private LocalDateTime fechaRegistro_usuario;

    @PrePersist
    public void prePersist() {
        this.fechaRegistro_usuario = LocalDateTime.now();
    }
    ...
    public Usuario(int id_usuario, String nombre_usuario, String dni_usuario, String sexo_usuario, String correo_usuario, String telefono_usuario, String direccion_usuario,  String password_usuario, Rol id_rol, Empresas idEmpresa) {
